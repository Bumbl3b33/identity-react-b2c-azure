export const msalConfig = {
  auth: {
    ...
    authority: 'https://.../b2c_1a_signup_signin', // Choose SUSI as your default authority.
    knownAuthorities: ['aaaaaaaa.b2clogin.com'], // Mark your B2C tenant's domain as trusted.
